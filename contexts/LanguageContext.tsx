...
const translations = {
  zh: {
    ...
    'market.gemini_analyst': 'Gemini 智能诊断',
    'market.analyzing': '正在分析基本面与资金流向...',
    'market.analysis_generated': '基于龙虎榜和基本面的AI诊断。',
    'market.click_analyze': '点击“诊断”以使用 AI 生成个股综合报告。',
    'market.btn.analyze': '股票 AI 诊断',
    'market.btn.update_analysis': '更新诊断',
    'market.indices': '大盘行情',
    'market.dragon_tiger': '龙虎榜资金流',
    'market.fundamentals': '个股详情 (基本面)',
    'market.pe': '市盈率 (TTM)',
    'market.pb': '市净率',
    'market.mkt_cap': '总市值',
    'market.eps': '每股收益',
  ...
  en: {
    ...
    'market.gemini_analyst': 'Gemini Diagnosis',
    'market.analyzing': 'Analyzing fundamentals & flow...',
    'market.analysis_generated': 'Diagnosis based on Dragon Tiger & Fundamentals.',
    'market.click_analyze': 'Click "Diagnosis" for a comprehensive AI report.',
    'market.btn.analyze': 'Stock AI Diagnosis',
    'market.btn.update_analysis': 'Update Diagnosis',
    'market.indices': 'Global Indices',
    'market.dragon_tiger': 'Dragon Tiger List',
    'market.fundamentals': 'Stock Details',
    'market.pe': 'P/E (TTM)',
    'market.pb': 'P/B',
    'market.mkt_cap': 'Market Cap',
    'market.eps': 'EPS',
    'market.sector': 'Sector',
    'market.turnover': 'Turnover',
    'market.dt.seat': 'Seat Name',
    'market.dt.buy': 'Buy (10k)',
    'market.dt.sell': 'Sell (10k)',
    'market.dt.net': 'Net (10k)',
